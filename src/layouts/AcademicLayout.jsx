...
const AcademicLayout = () => {
  ...
  return (
    <>
      <Navbar
        pageTitle={getPageTitle(location.pathname, currentLayoutSidebarData)}
      />
      ...
      <div className="flex  bg-gray-100">
        <Sidebar
          ...
          sidebarData={currentLayoutSidebarData}
        />
...
const getPageTitle = (currentRoute, sidebarData) => {
  const currentSidebarItem = sidebarData.find(
